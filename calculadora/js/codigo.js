/*
 objetos de las propiedades de la calculadora 
    ...
    calculadora: function(accion, digito) {
        switch (accion) {
            ...
            case "decimal":
                ...
                break;
            case "igual":
                p.operaciones.innerHTML = eval(p.operaciones.innerHTML); //separa los signos matematicos del string
                p.resultado = true;
                console.log("igual");
                break
        }
